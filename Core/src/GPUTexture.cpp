...
const std::string GPUTexture::LABEL = "LABEL";
const std::string GPUTexture::VERTEX_METRIC = "VERTEX_METRIC";
const std::string GPUTexture::NORMAL_METRIC_FILTERED = "NORMAL_METRIC_FILTERED";
//const std::string GPUTexture::MERGING_LABEL = "MERGING_LABEL";
