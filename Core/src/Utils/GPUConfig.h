...
class GPUConfig
{
    ...
    private:
           ...
           so3StepBlocks(64)
        {
			...
			//icpStepMap["GeForce GTX 1080"] = std::pair<int, int>(496, 32);
			//rgbStepMap["GeForce GTX 1080"] = std::pair<int, int>(480, 16);
			//rgbResMap["GeForce GTX 1080"] = std::pair<int, int>(512, 496);
			//so3StepMap["GeForce GTX 1080"] = std::pair<int, int>(128, 112);

			icpStepMap["GeForce GTX 1080"] = std::pair<int, int>(128, 80);
			rgbStepMap["GeForce GTX 1080"] = std::pair<int, int>(240, 32);
			rgbResMap["GeForce GTX 1080"] = std::pair<int, int>(432, 464);
			so3StepMap["GeForce GTX 1080"] = std::pair<int, int>(96, 112);

			icpStepMap["Quadro M4000"] = std::pair<int, int>(128, 272);
			rgbStepMap["Quadro M4000"] = std::pair<int, int>(224, 48);
			rgbResMap["Quadro M4000"] = std::pair<int, int>(256, 416);
			so3StepMap["Quadro M4000"] = std::pair<int, int>(128, 64);
