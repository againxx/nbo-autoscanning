...
class GPUTexture
{
    public:
        ...
        EFUSION_API static const std::string RGB, DEPTH_RAW, DEPTH_FILTERED, DEPTH_METRIC, DEPTH_METRIC_FILTERED, DEPTH_NORM, LABEL, VERTEX_METRIC, NORMAL_METRIC_FILTERED;// MERGING_LABEL;
