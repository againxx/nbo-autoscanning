...
class GUI
{
    public:
         ...
         : showcaseMode(showcaseMode)
        {
            ...
            savePatch = new pangolin::Var<bool>("ui.Save Patch", false, false);
            reset = new pangolin::Var<bool>("ui.Reset", false, false);
			autoScan = new pangolin::Var<bool>("ui.Auto Scan", false, true);
			stepScan = new pangolin::Var<bool>("ui.Step Scan", false, false);
			nextNBV = new pangolin::Var<bool>("ui.Next NBV", false, false);
			useYolo = new pangolin::Var<bool>("ui.Use YOLO", false, true);
            ...
            godView = new pangolin::Var<bool>("ui.God view", false, true);
			...
			drawSegmentaion = new pangolin::Var<bool>("ui.Draw segmentation", false, true);
			drawNBO = new pangolin::Var<bool>("ui.Draw nbo", true, true);
			drawNBV = new pangolin::Var<bool>("ui.Draw nbv", true, true);
			drawNBVTrajectory = new pangolin::Var<bool>("ui.Draw nbv trajectory", false, true);
			drawMatchedModels = new pangolin::Var<bool>("ui.Draw matched models", false, true);
        ...
        virtual ~GUI()
        {
            ...
            delete drawNormals;
            delete drawColors;
			delete drawSegmentaion;
			delete drawNBO;
			delete drawNBV;
			delete drawNBVTrajectory;
			delete drawMatchedModels;
		...
		inline void drawCross(const Eigen::Vector3f & pose)
		{
			if(showcaseMode)
				return;

			pangolin::glDrawCross((GLfloat)pose[0],(GLfloat)pose[1],(GLfloat)pose[2],0.3);
		}
